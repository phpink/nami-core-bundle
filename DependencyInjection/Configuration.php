...
class Configuration implements ConfigurationInterface
{
    ...
    public function getConfigTreeBuilder()
    {
        ...
        $rootNode
            ...
            ->scalarNode('public_key_path')->defaultValue('%kernel.root_dir%/../src/PhpInk/CoreBundle/config/jwt/public.pem')->end()
            ->scalarNode('private_key_path')->defaultValue('%kernel.root_dir%/../src/PhpInk/CoreBundle/config/jwt/private.pem')->end()
